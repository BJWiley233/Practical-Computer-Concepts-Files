...
class ProteinExample:
    ...
    def create_protein(self, database, prot_name, id_, type_):
        """
    ...
    def _delete_protein(self, database, uniprotID):
        """
        Private cause it will delete all relationships
