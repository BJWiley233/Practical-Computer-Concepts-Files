...
#for i in range(0, 4):    
    ...
    for idx, row in df_final.iterrows():
        ...
        ## no good ways to get protein names separate from alternative names
        ## as some names have `tRNA (something) rest of first name`
        ##
        ...
        try:
            cursor.execute(
                "REPLACE INTO proteinsUniprot VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
