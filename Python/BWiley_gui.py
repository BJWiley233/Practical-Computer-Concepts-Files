...
class Calculator:
    ...
    def __init__(self, master):
        ...
        '''
        self.entry = Entry(master, validate="key", width=26,
        ...
        self.add_button = Button(master, text="+", width=1, bg='seagreen',
                                 command=lambda: self.update_operator("+"))
        self.subtract_button = Button(master, text="-", width=1, bg='seagreen',
                                      command=lambda: self.update_operator("-"))
        self.divide_button = Button(master, text="/", width=1, bg='seagreen',
                                    command=lambda: self.update_operator("/"))
        self.multiply_button = Button(master, text="*", width=1, bg='seagreen',
                                      command=lambda: self.update_operator("*"))
        ...
        self.reset_button = Button(master, text="Reset", bg='seagreen', padx=2, 
        ...
        self.total_label.grid(row=0, columnspan=4, column=1, sticky="E")
        self.operator_label.grid(row=1, column=2, columnspan=6, padx=(100,0))
        self.entry.grid(row=2, column=0, columnspan=5, sticky=W, padx=(50,0))
        
        self.add_button.grid(row=3, column=0, padx=(50,0), sticky="EW")
        self.subtract_button.grid(row=3, column=1, sticky="EW")
        self.divide_button.grid(row=3, column=2, sticky="EW")
        self.multiply_button.grid(row=3, column=3, sticky="EW")
        self.reset_button.grid(row=3, column=4, padx=(22,0), sticky="NSE")
        self.equals_button.grid(row=4, column=4, padx=(10,0), sticky="NE")
        
        self.one_button.grid(row=4, column=0, padx=(50,0), sticky="NEWS")
        self.two_button.grid(row=4, column=1, sticky="NEWS")
        self.three_button.grid(row=4, column=2, sticky="NEWS")
        self.zero_button.grid(row=4, column=3, sticky="NEWS")
        self.four_button.grid(row=5, column=0, padx=(50,0), sticky="NEWS")
        self.five_button.grid(row=5, column=1, sticky="NEWS")
        self.six_button.grid(row=5, column=2, sticky="NEWS")
        self.decimal_button.grid(row=5, column=3, sticky="NEWS")
        self.seven_button.grid(row=6, column=0, padx=(50,0), sticky="NEWS")
        self.eight_button.grid(row=6, column=1, sticky="NEWS")
        self.nine_button.grid(row=6, column=2, sticky="NEWS")
        self.clr_last_button.grid(row=6, column=3, sticky="NEWS")
