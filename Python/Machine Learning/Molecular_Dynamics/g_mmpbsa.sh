...
echo '26 27' | /opt/g_mmpbsa/bin/g_mmpbsa -f /storage1/fs1/jheld/Active/Jason/MDS/FASTPockets_WILEY_1ERK_183THP2_185TP2_dt004/msm/trajectories_full/trj_gen0${gen}_kid00${kid}.xtc -s md.tpr -n residues10angstromsCA63.H2O_30anstromsCA63.ndx -pol polar.xvg -mme -mm energy_MM.xvg -pbsa -apol apolar.xvg -i $PROJECTS/BWILEYtest/GROMACS/I_D_G250E/Comp/mmpbsa.mdp -xvg xmgrace -pdie 2 -decomp
