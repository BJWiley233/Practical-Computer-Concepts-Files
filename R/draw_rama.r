...
grid.dir <- "C:/Users/bjwil/Downloads/top500-angles/pct/rama/"
scatter.filename <- "C:/Users/bjwil/OneDrive/Documents/R/1HMP_mmtk.tsv"

scatter.data <- load.scatter(scatter.filename)

png(filename="C:/Users/bjwil/OneDrive/Documents/R/1HMP.png",width=410, height=410)
